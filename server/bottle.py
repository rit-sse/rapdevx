...
import base64, cgi, email.utils, functools, hmac, http.client, imp, itertools, \
       mimetypes, os, re, subprocess, sys, tempfile, _thread, threading, time, \
       urllib.request, \
       urllib.parse, \
       urllib.error, warnings
...
urlencode, urlquote, urlunquote = urllib.parse.urlencode, urllib.parse.quote, urllib.parse.unquote
